...
<body class="layout-boxed">
    <div class="wrapper">
        ...
        $quer0='SELECT * FROM mangas WHERE mangaId='.$id.'';
        $res0=$db->query($quer0);
        ...
        <input type="text" placeholder="'.$data0[2].'">
        <button type="submit">Change</button>
        <p>Author Name (authorName):</p>
        <input type="text" placeholder="'.$data0[3].'">
        <button type="submit">Change</button>
        <p>Volume Number (volumeNumber):</p>
        <input type="text" placeholder="'.$data0[4].'">
        <button type="submit">Change</button>
        <p>Release Date (releaseDate):</p>
        <input type="text" placeholder="'.$data0[5].'">
        <button type="submit">Change</button>
        <p>Category Id (categoryId):</p>
        <input type="text" placeholder="'.$data0[6].'">
        <button type="submit">Change</button>
        <p>Views Number (viewsNumber):</p>
        <input type="text" placeholder="'.$data0[7].'">
        <button type="submit">Change</button>
        <p>Stock Left (stockLeft):</p>
        <input type="text" placeholder="'.$data0[8].'">
        <button type="submit">Change</button>
        <p>Price (price):</p>
        <input type="text" placeholder="'.$data0[9].'">
        <button type="submit">Change</button>
        <p>Description (description):</p>
        <input type="text" placeholder="'.$data0[10].'">
        <button type="submit">Change</button>
        </div>';
        ?>
